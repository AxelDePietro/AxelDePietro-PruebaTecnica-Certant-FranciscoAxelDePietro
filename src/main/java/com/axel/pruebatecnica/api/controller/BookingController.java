...
public class BookingController {
	...
	ModelAndView allBookings() {
		...
		List<BookingEntity> bookings = bookingService.allBookings();
	...
	ModelAndView myBookings(@AuthenticationPrincipal User user) throws Exception {

		// usuario con la sesion activa
		UserEntity userAux = userService.findByUsername(user.getUsername());

		ModelAndView mav = new ModelAndView("booking/misReservas");
