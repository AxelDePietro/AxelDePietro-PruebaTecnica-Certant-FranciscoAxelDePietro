package com.axel.pruebatecnica.api.configuration.filter;

import static com.axel.pruebatecnica.api.configuration.filter.TokenJwtConfig.*;
...
import com.axel.pruebatecnica.api.configuration.SimpleGrantedAuthorityJsonCreator;
